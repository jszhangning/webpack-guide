## 前言
通过安装[koa-webpack-middleware](https://www.npmjs.com/package/koa-webpack-middleware)依赖搭建服务器，此依赖主要是对[webpack-dev-middleware](https://www.npmjs.com/package/webpack-dev-middleware)、[webpack-hot-middleware](https://www.npmjs.com/package/webpack-hot-middleware)封装
...
```
npm install --save-dev koa-webpack-middleware
```
